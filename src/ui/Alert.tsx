...
export const Overlay: FC<AlertPrimitive.AlertDialogOverlayProps> = ({  className, ...props }) => {
  return <AlertPrimitive.Overlay className={cn('bg-background-opacity fixed z-[998] w-full h-full top-0  backdrop-blur-md', className)} {...props} />
}

export const Content: FC<React.ComponentPropsWithoutRef<typeof AlertPrimitive.Content>> = ({ children, className, ...props }) => {
  return <Portal>
    <Overlay />
