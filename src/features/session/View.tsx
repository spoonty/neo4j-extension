  ...
  return (
    <Drawer open modal>
      <Content className='right-[50%] translate-x-[50%]'>
        ...
        <div className='flex flex-col gap-5 py-4 px-2 h-[calc(100%-72px)]'>
          ...
          <div className='flex flex-col gap-2.5 w-[80%]'>
            <Input placeholder='Username' value={username} onValueChange={setUsername} />
            <Input placeholder='Password' value={password} onValueChange={setPassword} type='password' />
          </div>
        ...
        <Footer className='flex justify-end'>
          <Button variant='confirm' onClick={confirm}>Connect</Button>
        </Footer>
      </Content>
    </Drawer>
  )
