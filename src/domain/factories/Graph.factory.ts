...
import { GetByDegreeCaseImpl } from '@/domain/usecases/graph/GetByDegreeCase'
...
export class GraphFactory {
  ...
  getByDegreeCase(): GetByDegreeCase {
    return new GetByDegreeCaseImpl(this.graphRepository.getByDegree)
  }
}
